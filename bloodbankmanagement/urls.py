...
urlpatterns = [
    ...
    path('science', LogoutView.as_view(template_name='blood/science.html'),name='science'),
    path('science', views.afterlogin_view,name='science'),
    path('about_us', LogoutView.as_view(template_name='blood/about_us.html'),name='about_us'),
    path('about_us', views.afterlogin_view,name='about_us'),
    path('process', LogoutView.as_view(template_name='blood/science.html#process'),name='process'),
    path('benefits', LogoutView.as_view(template_name='blood/science.html#benefits'),name='benefits'),
